...
Open for the owner: whether the work compliance function can be approached at stage 1/2 under the venture framing; if not, stages 1–2 collapse to the internal reading (marked as such) and stage 3 is the first real validation.
