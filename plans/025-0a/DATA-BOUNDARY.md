# DATA-BOUNDARY - 0A-4 internal draft, 2026-08-25
...
| Approved short text | change title, review summary, approval rationale, denial/refusal category | UTF-8; 256 bytes/field, 1 KiB aggregate/event | Plain text only; no markup, URLs, code, logs, prompts, transcript excerpts, stack traces, secrets, or artifact snippets. Scanned before retention. |
...
- Use registered enums for actions, outcomes, warnings, reasons, scopes, and policy states. Free text is exceptional, bounded, scanned, and excluded from security decisions.
